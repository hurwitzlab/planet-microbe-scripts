...
def delete_all(db):
    ...
    cursor = db.cursor()
    cursor.execute(
        "TRUNCATE project_to_sample CASCADE;"
        "TRUNCATE sample_to_sampling_event CASCADE;"
        "TRUNCATE project_to_file CASCADE;"
        "TRUNCATE run_to_file CASCADE;"
        ...
        "TRUNCATE sampling_event_data CASCADE;"
        "TRUNCATE sampling_event CASCADE;"
        "TRUNCATE schema CASCADE;"
